...
- [Day 46](daily/2026-06-26.md) — **Phase 3 기출회독 진입** 2021년 정처기 필기 (회독 1/4) 5과목 균등 20문제(비기능요구사항·UML 정적/동적·GoF 3분류·MVC·스택 활용·정렬 평균 복잡도·블랙박스 기법·SCM/CI/CD·2NF·DDL분류·ACID 원자성·View 특성·C 포인터 산술·Java 다형성·Python 슬라이싱·페이지교체 vs 스케줄링·XP 5가치·블록체인·OSI 7계층·대칭/공개키) (Phase 3) — Phase 3 1일차
...
- [Day 37](daily/2026-06-17.md) — 1과목 아키텍처 + 응집도·결합도 2회독 통합(응집도 7단계 약→강 "우·논·시·절·통·순·기"·결합도 6단계 "자·스·제·외·공·내"·황금률 "높은 응집도+낮은 결합도"·아키텍처 7패턴(레이어드·MVC·파이프필터·브로커·블랙보드·마스터슬레이브·이벤트버스)·Kruchten 4+1 뷰 "논·프·개·물+시"·평가 4종 SAAM·ATAM(트레이드오프)·CBAM·ARID) (1과목) — Phase 2 1과목 마무리
